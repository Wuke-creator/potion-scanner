...
_HELP = (
    ...
    "/connect - set up 1-Tap Trade (Elite only)\n"
    "/trading - 1-Tap Trade status + last trade\n"
    "/trading\\_settings - slippage and size presets\n"
    "/disconnect - wipe your trading delegate key\n"
    "/help - this message\n\n"
